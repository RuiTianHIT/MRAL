...
checkpoint_config = dict(interval=1, max_keep_ckpts=50, by_epoch=True)
log_config = dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/root/autodl-tmp/PPAL/data/VOC0712/annotations/train_num_095ws_filtered.json',
...
work_dir = 'train_num_095ws_filtered'
auto_resume = False
gpu_ids = range(0, 1)
